...
`)
  ...
  assert.match(agentLiveStreamSource, /function ReasoningSummary/)
  assert.match(agentLiveStreamSource, /推理摘要/)
  assert.match(agentLiveStreamSource, /ArtifactRendererLabel/)
  assert.match(agentLiveStreamSource, /恢复动作/)
  ...
  assert.match(agentThinkingSummarySource, /MIN_VISIBLE_THINKING_ELAPSED_MS/)
  assert.match(agentThinkingSummarySource, /elapsedMs < MIN_VISIBLE_THINKING_ELAPSED_MS/)
  assert.match(agentThinkingSummarySource, /\.toFixed\(1\)\}s/)
  assert.match(agentThinkingSummarySource, /buildHistorySummaryStages/)
  assert.match(agentThinkingSummarySource, /QUIET_STAGE_IDS/)
  assert.match(agentThinkingSummarySource, /getMeaningfulStages/)
  assert.match(agentThinkingSummarySource, /过程详情/)
  assert.match(agentThinkingSummarySource, /工具/)
  assert.match(agentThinkingSummarySource, /产物/)
  assert.match(agentThinkingSummarySource, /异常/)
  assert.match(agentThinkingSummarySource, /推理摘要/)
  assert.match(agentThinkingSummarySource, /整理输出/)
  assert.doesNotMatch(agentThinkingSummarySource, /<span className="shrink-0 font-mono">Agent<\/span>/)
