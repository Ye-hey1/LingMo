...
`)
  ...
  assert.match(chatCssSource, /\.mermaid-canvas-controls\s*\{[\s\S]{0,360}display:\s*inline-flex/)
  assert.match(chatCssSource, /\.mermaid-canvas-controls\s*\{[\s\S]{0,520}flex-wrap:\s*nowrap/)
  assert.match(chatCssSource, /\.mermaid-canvas-controls\s*\{[\s\S]{0,700}opacity:\s*0\.72/)
