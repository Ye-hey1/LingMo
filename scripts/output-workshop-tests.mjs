...
try {
  ...
  assert.match(utilsTemplatePreviewSource, /buildMokaTemplatePreviewHtml/)
  assert.match(utilsTemplatePreviewSource, /isMokaTemplateId\(template\.id\)/)
  ...
  assert.match(utilsTemplatePreviewSource, /Creative Output Lab/)
