...
const targetPath = 'C:\\Users\\colin\\Desktop\\AI demo\\LingMo\\docs\\app\\memory\\page.tsx';
      ...
      <DualLang
        zh={
          <Callout title="使用建议" tone="success">
            <p>
              不要把每次与 AI 的琐碎聊天都保存下来。建议重点筛选具有“决策价值”、“排错链路”、“命令参数”或“核心算法结论”的会话导出至本地库中，保证您的知识库质量处于高水准。
            </p>
          </Callout>
        }
        en={
...
console.log('Successfully wrote Memory page with UTF-8 encoding');
